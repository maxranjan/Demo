class CustomThread extends Thread {
    ...
    public void run() {
      //  System.out.println("Thread1, Sum of 10 and 20 = " + s.add(10, 20)); // Int add part 
...
public void run()
{
   // System.out.println("Thread2, Sum of 100 and 200 = "+ s.add(100,200));// Int add part
...
class CustomThread2 extends Thread {
    ...
    public void run() {
      //  System.out.println("Thread2, Sum of 1000 and 2000 = " + s.add(1000, 2000));// Int add part
